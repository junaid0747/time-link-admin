                ...
                <div class="login-card">
                    <div>
                        <div><a class="logo text-start" href="{{ url('/') }}"><img class="img-fluid for-light"
                                    src="{{ url('adminNew/assets/images/logo/logo.png') }}" alt="looginpage"
                                    style="width: 150px"><img class="img-fluid for-dark"
                                    src="{{ url('adminNew/assets/images/logo/logo_dark.png') }}" alt="looginpage"></a></div>
