...
<script src="{{ asset('adminNew') }}/assets/js/chart/apex-chart/chart-custom.js"></script>
<!-- Plugins JS start-->
{{-- <script src="{{ asset('adminNew') }}/assets/js/sidebar-menu.js"></script> --}}
 <script src="{{ asset('adminNew') }}/assets/js/chart/flot-chart/excanvas.js"></script>
 <script src="{{ asset('adminNew') }}/assets/js/chart/flot-chart/jquery.flot.js"></script>
 <script src="{{ asset('adminNew') }}/assets/js/chart/flot-chart/jquery.flot.time.js"></script>
 <script src="{{ asset('adminNew') }}/assets/js/chart/flot-chart/jquery.flot.categories.js"></script>
 <script src="{{ asset('adminNew') }}/assets/js/chart/flot-chart/jquery.flot.stack.js"></script>
 <script src="{{ asset('adminNew') }}/assets/js/chart/flot-chart/jquery.flot.pie.js"></script>
 <script src="{{ asset('adminNew') }}/assets/js/chart/flot-chart/jquery.flot.symbol.js"></script>
<script src="{{ asset('adminNew') }}/assets/js/chart/flot-chart/flot-script.js"></script>
