...
$images = GeneralSettings::first();
// dd($images);
?>
<div class="sidebar-wrapper">
    <div>
        <div class="logo-wrapper">
            <a href="{{ route('dashboard.new') }}"><img class="img-fluid dashboard_logo_image for-light"
                    src="<?= $images->dashboard_logo ?>" alt="">
                <img class="img-fluid dashboard_logo_image for-dark"
                    src="<?= $images->dashboard_logo ?>"alt=""></a>
            <div class="toggle-sidebar"><i class="status_toggle middle sidebar-toggle" data-feather="grid"> </i>
            </div>
        </div>
        <div class="logo-icon-wrapper"><a href="#"><img class="img-fluid" src="<?= $images->dashboard_logo ?>"
                    alt=""></a></div>
            ...
            <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                    <li class="back-btn"><a href="index.html"><img class="img-fluid"
                                src="{{ asset('adminNew') }}/assets/images/logo/logo-icon.png" alt=""></a>
                    ...
                    <li class="sidebar-list">
                        ...
                        <ul class="sidebar-submenu">
                            <li><a class="lan-4" href="{{ route('dashboard.new') }}">Default</a></li>
                    ...
                    <li class="sidebar-list">
                        ...
                        <ul class="sidebar-submenu">
                            <li><a href="{{ route('user.list.new') }}">User List</a></li>
                            <li><a href="{{ route('user.create.new', ['id' => 0]) }}">Add new User</a></li>
                        </ul>
                    </li>
                    <li class="sidebar-list">
                        <label class="badge badge-light-secondary">New</label><a class="sidebar-link sidebar-title"
                            href="#"><i data-feather="layers"></i><span>General Settings </span></a>
                        <ul class="sidebar-submenu">
                            <li><a href="{{ route('general.setings') }}">Images Module</a></li>
                            {{-- <li><a href="{{route('user.create.new',['id'=>0])}}">Add new User</a></li> --}}
                        </ul>
                    </li>
                    <li class="sidebar-list">
                        <label class="badge badge-light-secondary">New</label><a class="sidebar-link sidebar-title"
                            href="#"><i data-feather="globe"></i><span>Business</span></a>
                        <ul class="sidebar-submenu">
                            <li><a href="{{ route('business.listing') }}">Listing</a></li>
                            {{-- <li><a href="{{route('user.create.new',['id'=>0])}}">Add new User</a></li> --}}
                        </ul>
                    </li>
                    <li class="sidebar-list">
                        <label class="badge badge-light-secondary">New</label><a class="sidebar-link sidebar-title"
                            href="#"><i data-feather="shopping-bag"></i><span>Products</span></a>
                        <ul class="sidebar-submenu">
                            <li><a href="{{ route('products.listing') }}">Listing</a></li>
                            {{-- <li><a href="{{route('user.create.new',['id'=>0])}}">Add new User</a></li> --}}
                        </ul>
                    </li>
                    <li class="sidebar-list">
                        <label class="badge badge-light-secondary">New</label><a class="sidebar-link sidebar-title"
                            href="#"><i data-feather="box"></i><span>Orders</span></a>
                        <ul class="sidebar-submenu">
                            <li><a href="{{ route('orders.listing') }}">Listing</a></li>
                            {{-- <li><a href="{{route('user.create.new',['id'=>0])}}">Add new User</a></li> --}}
                        </ul>
                    </li>
                    {{-- subscription.detail --}}
                    <li class="sidebar-list">
                        <label class="badge badge-light-secondary">New</label><a class="sidebar-link sidebar-title"
                            href="#"><i data-feather="check-square"></i><span>Subscriptions</span></a>
                        <ul class="sidebar-submenu">
                            <li><a href="{{ route('subscription.listing') }}">Listing</a></li>
                            <li><a href="{{ route('subscription.create', ['id' => 0]) }}">Add new Subscription</a></li>
                        </ul>
                    </li>
                    <br><br>
                    {{-- <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                            ...
                            <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                    href="social-app.html"><i data-feather="zap"> </i><span>Social App</span></a></li>
                            <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                            ...
                            <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#"><i
                                ...
                                <ul class="sidebar-submenu">
                                    ...
                                    <li><a class="submenu-title" href="#">Ex. Data Tables<span
                                                class="sub-arrow"><i class="fa fa-angle-right"></i></span></a>
                                        <ul class="nav-sub-childmenu submenu-content">
                            ...
                            <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                    href="landing-page.html"><i data-feather="cast"> </i><span>Landing page</span></a>
                            </li>
                            <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                            ...
                            <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                    href="{{ asset('adminNew') }}/starter-kit/index.html" target="_blank"><i
