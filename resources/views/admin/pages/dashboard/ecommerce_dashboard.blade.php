                                ...
                                <div class="card-header card-no-border">
                                    ...
                                    <div class="media">
                                        <div class="media-body">
                                            <p class="font-roboto"><span class="f-w-500">Today Total sale</span><span
                        ...
                        <div class="col-xl-6 box-col-6 col-md-6">
                            <div class="card o-hidden">
                                <div class="card-header card-no-border">
                                    ...
                                    <div class="media">
                                        <div class="media-body">
                                            <p class="font-roboto"><span class="f-w-500">Today Total visits</span><span
                                ...
                                <div class="card-body p-0">
                                    <div class="offer-slider">
                                        <div class="carousel slide" id="carouselExampleCaptions" data-bs-ride="carousel">
                                                        ...
                                                        <div class="col-xl-4 col-md-6">
                                                            <div class="d-flex">
                                                                <div class="left-content">
                                                                    ...
                                                                    <h4 class="f-w-600">Best Selling Product</h4><span
                                                                        class="badge badge-white rounded-pill">78%
                                                                        offer</span><span
                                                        ...
                                                        <div class="col-xl-4 col-md-6">
                                                            <div class="d-flex">
                                                                <div class="left-content">
                                                                    ...
                                                                    <h4 class="f-w-600">Best Selling Product</h4><span
                                                                        class="badge badge-white rounded-pill">50%
                                                                        offer</span><span
                                                                        class="badge badge-dotted rounded-pill ms-2">Coupon
                                                                        Code : 21546</span>
                                                                </div>
                                            ...
                                            </div><a class="carousel-control-prev" href="#carouselExampleCaptions"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="text-end"><span
                                                                    class="badge badge-light-success"><i class="me-2"
                                                                        data-feather="check"></i>Done</span></td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <div class="d-inline-block align-middle"><img
                                                                        class="img-40 m-r-15 rounded-circle align-top"
                                                                        src="../assets/images/avtar/4.jpg" alt="">
                                                                    <div class="status-circle bg-primary"></div>
                                                            ...
                                                            <td class="text-end"><span
                                                                    class="badge badge-light-warning"><i class="me-2"
                                                                        data-feather="rotate-cw"></i>Pending</span></td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <div class="d-inline-block align-middle"><img
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-end"> <span class="badge badge-light-info"><i
                                                                        class="me-2" data-feather="clock"></i>In
                                                                    progress</span></td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <div class="d-inline-block align-middle"><img
                                                                        class="img-40 m-r-15 rounded-circle align-top"
                                                                        src="../assets/images/avtar/3.jpg" alt="">
                                                                    <div class="status-circle bg-primary"></div>
