$(document).ready(function () {
    ...
    // Business tables
    var table = $('#business-detail-1').DataTable();
    $('#business-detail-1 tbody').on('click', 'tr', function () {
        var data = table.row(this).data();
        alert('You clicked on ' + data[0] + '\'s row');
    });
    var table = $('#business-detail-2').DataTable();
    $('#business-detail-2 tbody').on('click', 'tr', function () {
        var data = table.row(this).data();
        alert('You clicked on ' + data[0] + '\'s row');
    });
    var table = $('#business-detail-3').DataTable();
    $('#business-detail-3 tbody').on('click', 'tr', function () {
        var data = table.row(this).data();
        alert('You clicked on ' + data[0] + '\'s row');
    });
    var table = $('#business-detail-4').DataTable();
    $('#business-detail-4 tbody').on('click', 'tr', function () {
        var data = table.row(this).data();
        alert('You clicked on ' + data[0] + '\'s row');
    });
    var table = $('#business-detail-5').DataTable();
    $('#business-detail-5 tbody').on('click', 'tr', function () {
        var data = table.row(this).data();
        alert('You clicked on ' + data[0] + '\'s row');
    });
    var table = $('#business-detail-6').DataTable();
    $('#business-detail-5 tbody').on('click', 'tr', function () {
        var data = table.row(this).data();
        alert('You clicked on ' + data[0] + '\'s row');
    });
    ...
    // // User tables
    // var table = $('#user-detail-1').DataTable();
    // $('#user-detail-1 tbody').on('click', 'tr', function () {
    //     var data = table.row(this).data();
    //     alert('You clicked on ' + data[0] + '\'s row');
    // });
    // var table = $('#user-detail-2').DataTable();
    // $('#user-detail-2 tbody').on('click', 'tr', function () {
    //     var data = table.row(this).data();
    //     alert('You clicked on ' + data[0] + '\'s row');
    // });
    // var table = $('#user-detail-3').DataTable();
    // $('#user-detail-3 tbody').on('click', 'tr', function () {
    //     var data = table.row(this).data();
    //     alert('You clicked on ' + data[0] + '\'s row');
    // });
    // var table = $('#user-detail-4').DataTable();
    // $('#user-detail-4 tbody').on('click', 'tr', function () {
    //     var data = table.row(this).data();
    //     alert('You clicked on ' + data[0] + '\'s row');
    // });
    // var table = $('#user-detail-5').DataTable();
    // $('#user-detail-5 tbody').on('click', 'tr', function () {
    //     var data = table.row(this).data();
    //     alert('You clicked on ' + data[0] + '\'s row');
    // });
    // var table = $('#user-detail-6').DataTable();
    // $('#user-detail-5 tbody').on('click', 'tr', function () {
    //     var data = table.row(this).data();
    //     alert('You clicked on ' + data[0] + '\'s row');
    // });
