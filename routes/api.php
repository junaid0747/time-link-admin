...
use App\Http\Controllers\APIGeneralSettingController;
...
Route::group(['middleware' => 'auth:sanctum'], function () {
    ...
    // Busniess routes...
    Route::post('business', [BusinessController::class, 'busniess_update']);
    Route::delete('business/{id}', [BusinessController::class, 'delete_business']);
    Route::get('business/payment-plan/{business_id}', [BusinessController::class, 'business_payment_plan']);
    Route::post('business/payment-plan', [BusinessController::class, 'business_payment_plan']);
    Route::post('business/location', [BusinessController::class, 'business_location']);
    Route::post('user-device-token', [BusinessController::class, 'user_device_token']);
    Route::post('rate/business', [BusinessController::class, 'rate_business']);
    Route::post('upload/multiple/files', [BusinessController::class, 'upload_multiple_files']);
    Route::get('multiple/images', [BusinessController::class, 'multiple_images']);
    Route::get('busniess/list', [BusinessController::class, 'busniess_list']);

    // Business Products Routes
    Route::post('busniess/add-product', [BusinessController::class, 'addproduct']);
    Route::post('busniess/edit-product', [BusinessController::class, 'editproduct']);
    Route::delete('business/product/{id}', [BusinessController::class, 'delete_product']);
    Route::get('business/product/{id}', [BusinessController::class, 'productdetail']);
    Route::get('business/all-product/{id}', [BusinessController::class, 'businessAllProduct']);
    ...
    Route::post('/business-plan', [ApiNewController::class, 'businessPlan']);

    // Orders
    Route::post('/create-order', [ApiNewController::class, 'createOrder']);
    Route::get('/order-list', [ApiNewController::class, 'orderList']);
});
Route::post('general/settings', [APIGeneralSettingController::class, 'change_logo']);
Route::get('/order-by/{businessId}/{orderId}', [ApiNewController::class, 'orderBy_BusinessId_OrderId']);
Route::post('/get-latest-order', [ApiNewController::class, 'getLatestOrder']);

//  NEW API START HERE
Route::post('/send-otp', [ApiNewController::class, 'sendOtp']);
Route::post('/verify-otp', [ApiNewController::class, 'verifyOtp']);
Route::post('/register-account', [ApiNewController::class, 'registerAccount']);
Route::post('/sign-in', [ApiNewController::class, 'signIn']);
Route::post('/sign-in-otp', [ApiNewController::class, 'signInOtp']);
