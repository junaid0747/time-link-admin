                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card m-b-30">
                                    ...
                                    ?>
                                        <form class="" action="{{route('slider.submit',$update_id)}}" method="post" enctype="multipart/form-data">
                                            @csrf
                                          ...
                                          <div class="col-md-6">
                                            <div class="form-group">
                                                    <label>Url</label>
                                                    <input type="text" name="url" value="<?=(isset($obj->url) && !empty($obj->url) ? $obj->url:'')?>" class="form-control" required placeholder="Type something"/>
                                                </div>
                                          </div>
