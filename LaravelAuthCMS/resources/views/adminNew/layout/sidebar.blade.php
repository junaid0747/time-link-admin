        ...
        <div class="sidebar-wrapper">
            <div>
                <div class="logo-wrapper"><a href="index.html"><img class="img-fluid for-light"
                            src="{{ asset('adminNew') }}/assets/images/logo/logo.png" alt=""><img
                            class="img-fluid for-dark" src="{{ asset('adminNew') }}/assets/images/logo/logo_dark.png"
                            alt=""></a>
                ...
                <div class="logo-icon-wrapper"><a href="index.html"><img class="img-fluid"
                            src="{{ asset('adminNew') }}/assets/images/logo/logo-icon.png" alt=""></a></div>
                <nav class="sidebar-main">
                    <div class="left-arrow" id="left-arrow"><i data-feather="arrow-left"></i></div>
                    <div id="sidebar-menu">
                        <ul class="sidebar-links" id="simple-bar">
                            <li class="back-btn"><a href="index.html"><img class="img-fluid"
                                        src="{{ asset('adminNew') }}/assets/images/logo/logo-icon.png"
                                        alt=""></a>
                            ...
                            <li class="sidebar-list">
                                <label class="badge badge-light-secondary">New</label><a
                                    class="sidebar-link sidebar-title" href="#"><i
                                        data-feather="box"></i><span>Users </span></a>
                                <ul class="sidebar-submenu">
                            ...
                            <li class="sidebar-list">
                                <label class="badge badge-light-secondary">New</label><a
                                    class="sidebar-link sidebar-title" href="#"><i
                                    data-feather="box"></i><span>General Settings </span></a>
                                <ul class="sidebar-submenu">
                                    <li><a href="{{route('head.img.form')}}">Images Module</a></li>
                                    {{-- <li><a href="{{route('user.create.new',['id'=>0])}}">Add new User</a></li> --}}
                                </ul>
                            </li>
